      ...
      {word.letterStates.map((letter, index) => {
        return (
          <span
            key={index}
            className={clsx(
              letter.status === 'correct' && classes.correctLetter,
...
const UnconnectedTypingLineStatusDisplay: React.FC<TypingLineStatusDisplayProps> = (props) => {
...
export const TypingLineStatusDisplay = connect<TypingLineStatusDisplayProps,
  {},
  {},
  IRootState>((s) => {
  return {
